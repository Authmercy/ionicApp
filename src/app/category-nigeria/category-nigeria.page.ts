...
import { DatanigeriaService } from '../provider/datanigeria.service';

@Component({
  selector: 'app-category-nigeria',
  templateUrl: './category-nigeria.page.html',
  styleUrls: ['./category-nigeria.page.scss'],
})
export class CategoryNigeriaPage implements OnInit {
  ...
  listRestaurant: any[] = [];
  listSupermarche: any[] = []
  constructor(private dataService: DatanigeriaService,private router: Router) { }
